...
def scrape_map_data():
	modes = {"Standard Battle" : "1", "Encounter Battle" : "257", "Assault" : "513"}
	map_dict = {}
	for mode in modes:
		url = 'http://www.vbaddict.net/statistics_maps.php?modeid=' + modes[mode]+'&groupby=3&fieldname=won_lost_ratio'
